      ...
      <div className="Mih(1000px)">
          ...
          <div className="Maw(1280px) Mx(a) Pos(r)">
            ...
            <span className="Pos(a) End(40px) B(10px)">
              <span className="Fw(b) Mstart(20px) Pos(r) C(dodgerblue):h">
                New v
                <select className="Pos(a) Start(0) W(100%) Op(0) Cur(p)">
                  <option value="article">New article</option>
                  <option value="company">New private company</option>
                </select>
              </span>
              <span className="Fw(b) Mstart(20px) Pos(r) C(dodgerblue):h">
                Kailang v
                <select className="Pos(a) Start(0) W(100%) Op(0) Cur(p)" onChange={(e) => e.target.value}>
        ...
        <div className="Bgc(aliceblue) Bxsh($cardShadow)">
          <div className="Maw(1280px) Mx(a)">
            ...
            <Link className="Fw(b) Lh(2) Mend(30px)" to="/markets">Markets</Link>
            <Link className="Fw(b) Lh(2) Mend(30px)" to="/industries">Industries</Link>
          </div>
        </div>
